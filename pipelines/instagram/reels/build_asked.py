...
def write_html(r, workdir, timing, design="asked2"):
    ...
    for f in ("logo.png", "sal-thinking.png", "sal-smile.png", "sal-standing.png"):
    ...
    html = (tpl.replace("__INTER__", data_uri(os.path.join(fonts, "Inter-latin.woff2")))
               ...
               .replace("__SAL_THINK__", "assets/sal-thinking.png").replace("__SAL_STAND__", "assets/sal-standing.png")
